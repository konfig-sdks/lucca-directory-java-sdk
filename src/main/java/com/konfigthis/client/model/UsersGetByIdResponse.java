...
import com.konfigthis.client.model.UsersGetByIdResponseCalendar;
import com.konfigthis.client.model.UsersGetByIdResponseCulture;
import com.konfigthis.client.model.UsersGetByIdResponseDepartment;
import com.konfigthis.client.model.UsersGetByIdResponseLegalEntity;
import com.konfigthis.client.model.UsersGetByIdResponseManager;
import com.konfigthis.client.model.UsersGetByIdResponsePicture;
import com.konfigthis.client.model.UsersGetByIdResponseRolePrincipal;
...
public class UsersGetByIdResponse {
  ...
  private UsersGetByIdResponseCalendar calendar;

  public static final String SERIALIZED_NAME_CULTURE = "culture";
  @SerializedName(SERIALIZED_NAME_CULTURE)
  private UsersGetByIdResponseCulture culture;

  public static final String SERIALIZED_NAME_PICTURE = "picture";
  @SerializedName(SERIALIZED_NAME_PICTURE)
  private UsersGetByIdResponsePicture picture;
  ...
  public UsersGetByIdResponse id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "416", value = "")
  ...
  public UsersGetByIdResponse name(String name) {
  ...
  **/
  ...
  public UsersGetByIdResponse url(String url) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://lucca.test/api/users/1", value = "")
  ...
  public UsersGetByIdResponse displayName(String displayName) {
  ...
  **/
  ...
  public UsersGetByIdResponse modifiedOn(String modifiedOn) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2015-09-07T10:20:06.583", value = "")
  ...
  public UsersGetByIdResponse lastName(String lastName) {
  ...
  **/
  ...
  public UsersGetByIdResponse firstName(String firstName) {
  ...
  **/
  ...
  public UsersGetByIdResponse login(String login) {
  ...
  **/
  ...
  public UsersGetByIdResponse mail(String mail) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "no-reply@lucca.fr", value = "")
  ...
  public UsersGetByIdResponse dtContractStart(String dtContractStart) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2014-09-01T00:00:00", value = "")
  ...
  public UsersGetByIdResponse dtContractEnd(ModelNull dtContractEnd) {
  ...
  **/
  ...
  public UsersGetByIdResponse birthDate(String birthDate) {
  ...
  **/
  ...
  public UsersGetByIdResponse employeeNumber(String employeeNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "00057", value = "")
  ...
  public UsersGetByIdResponse calendar(UsersGetByIdResponseCalendar calendar) {
  ...
  **/
  ...
  public UsersGetByIdResponseCalendar getCalendar() {
    return calendar;
  }


  public void setCalendar(UsersGetByIdResponseCalendar calendar) {
  ...
  public UsersGetByIdResponse culture(UsersGetByIdResponseCulture culture) {
  ...
  **/
  ...
  public UsersGetByIdResponseCulture getCulture() {
    return culture;
  }


  public void setCulture(UsersGetByIdResponseCulture culture) {
  ...
  public UsersGetByIdResponse picture(UsersGetByIdResponsePicture picture) {
  ...
  **/
  ...
  public UsersGetByIdResponsePicture getPicture() {
    return picture;
  }


  public void setPicture(UsersGetByIdResponsePicture picture) {
  ...
  public UsersGetByIdResponse applicationData(Object applicationData) {
  ...
  **/
  ...
  public UsersGetByIdResponse legalEntity(UsersGetByIdResponseLegalEntity legalEntity) {
  ...
  **/
  ...
  public UsersGetByIdResponseLegalEntity getLegalEntity() {
    return legalEntity;
  }


  public void setLegalEntity(UsersGetByIdResponseLegalEntity legalEntity) {
  ...
  public UsersGetByIdResponse department(UsersGetByIdResponseDepartment department) {
  ...
  **/
  ...
  public UsersGetByIdResponseDepartment getDepartment() {
    return department;
  }


  public void setDepartment(UsersGetByIdResponseDepartment department) {
  ...
  public UsersGetByIdResponse manager(UsersGetByIdResponseManager manager) {
  ...
  **/
  ...
  public UsersGetByIdResponseManager getManager() {
    return manager;
  }


  public void setManager(UsersGetByIdResponseManager manager) {
  ...
  public UsersGetByIdResponse rolePrincipal(UsersGetByIdResponseRolePrincipal rolePrincipal) {
  ...
  **/
  ...
  public UsersGetByIdResponseRolePrincipal getRolePrincipal() {
    return rolePrincipal;
  }


  public void setRolePrincipal(UsersGetByIdResponseRolePrincipal rolePrincipal) {
  ...
  public UsersGetByIdResponse habilitedRoles(List<UsersListExcludedFormerResponseItemsInnerCulture> habilitedRoles) {
  ...
  public UsersGetByIdResponse addHabilitedRolesItem(UsersListExcludedFormerResponseItemsInnerCulture habilitedRolesItem) {
  ...
  **/
  ...
  public UsersGetByIdResponse userWorkCycles(List<UsersListExcludedFormerResponseItemsInnerUserWorkCyclesInner> userWorkCycles) {
  ...
  public UsersGetByIdResponse addUserWorkCyclesItem(UsersListExcludedFormerResponseItemsInnerUserWorkCyclesInner userWorkCyclesItem) {
  ...
  **/
   ...
   * @return the UsersGetByIdResponse instance itself
   */
  public UsersGetByIdResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UsersGetByIdResponse usersGetByIdResponse = (UsersGetByIdResponse) o;
    return Objects.equals(this.id, usersGetByIdResponse.id) &&
        Objects.equals(this.name, usersGetByIdResponse.name) &&
        Objects.equals(this.url, usersGetByIdResponse.url) &&
        Objects.equals(this.displayName, usersGetByIdResponse.displayName) &&
        Objects.equals(this.modifiedOn, usersGetByIdResponse.modifiedOn) &&
        Objects.equals(this.lastName, usersGetByIdResponse.lastName) &&
        Objects.equals(this.firstName, usersGetByIdResponse.firstName) &&
        Objects.equals(this.login, usersGetByIdResponse.login) &&
        Objects.equals(this.mail, usersGetByIdResponse.mail) &&
        Objects.equals(this.dtContractStart, usersGetByIdResponse.dtContractStart) &&
        Objects.equals(this.dtContractEnd, usersGetByIdResponse.dtContractEnd) &&
        Objects.equals(this.birthDate, usersGetByIdResponse.birthDate) &&
        Objects.equals(this.employeeNumber, usersGetByIdResponse.employeeNumber) &&
        Objects.equals(this.calendar, usersGetByIdResponse.calendar) &&
        Objects.equals(this.culture, usersGetByIdResponse.culture) &&
        Objects.equals(this.picture, usersGetByIdResponse.picture) &&
        Objects.equals(this.applicationData, usersGetByIdResponse.applicationData) &&
        Objects.equals(this.legalEntity, usersGetByIdResponse.legalEntity) &&
        Objects.equals(this.department, usersGetByIdResponse.department) &&
        Objects.equals(this.manager, usersGetByIdResponse.manager) &&
        Objects.equals(this.rolePrincipal, usersGetByIdResponse.rolePrincipal) &&
        Objects.equals(this.habilitedRoles, usersGetByIdResponse.habilitedRoles) &&
        Objects.equals(this.userWorkCycles, usersGetByIdResponse.userWorkCycles)&&
        Objects.equals(this.additionalProperties, usersGetByIdResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsersGetByIdResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsersGetByIdResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsersGetByIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsersGetByIdResponse is not found in the empty JSON string", UsersGetByIdResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsersGetByIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsersGetByIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsersGetByIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsersGetByIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UsersGetByIdResponse>() {
           @Override
           public void write(JsonWriter out, UsersGetByIdResponse value) throws IOException {
           ...
           @Override
           public UsersGetByIdResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UsersGetByIdResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UsersGetByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UsersGetByIdResponse
  * @throws IOException if the JSON string is invalid with respect to UsersGetByIdResponse
  */
  public static UsersGetByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsersGetByIdResponse.class);
  }

 /**
  * Convert an instance of UsersGetByIdResponse to an JSON string
  *
  * @return JSON string
  */
